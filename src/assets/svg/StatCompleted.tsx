...
const StatCompleted = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" className='h-8 w-8'>
        ...
        <path d="M21 9.59L17.41 6L16 7.41l5 5l9-9L28.59 2L21 9.59z" fill="currentColor">
        </path>
        <path d="M23.8 14a7.28 7.28 0 0 1-2.622 4.143C20.107 19.135 19 20.16 19 22h2c0-.92.526-1.45 1.535-2.386A9.143 9.143 0 0 0 25.84 14z" fill="currentColor">
        </path>
    </svg>
  );
};
