...
const EarlyStageTasks = () => {
  ...
  return (
    <section className='w-full px-2 container flex flex-col space-y-8 items-center my-4 todo-list text-slate-700 dark:text-slate-400'>
        ...
        <Link href='/task-list'>
            <span className='py-1 px-2 sm:py-2 sm:px-3 text-md font-bold bg-slate-950 dark:bg-slate-200 text-slate-100 dark:text-slate-950 rounded-md shadow-lg shadow-slate-900 hover:ring-1 hover:ring-offset-2 hover:ring-offset-slate-900 hover:ring-slate-900 dark:hover:ring-slate-100 ease-in duration-200'>🗂️ Task Database</span>
        </Link>
    </section>
  );
};
