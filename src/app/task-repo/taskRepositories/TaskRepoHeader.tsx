          ...
          <Dialog as="div" className="relative h-fit z-10 top-[50%]" onClose={() => handleClose()}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full py-4 border-2 text-slate-700 dark:text-slate-400 border-slate-500/50 dark:border-slate-600/10 max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-slate-950 pt-4 px-6 text-left align-middle shadow-xl transition-all">
                    <Dialog.Title
                      as="h3"
                    ...
                    <div>
                      ...
                      <ol className='list-decimal'>
                        <li>
                          <strong>Orange, Green, and Grey Balls:</strong>
                        ...
                        <li>
                          <strong>Edit and Delete Buttons:</strong>
                          <ul className='flex flex-col space-y-2 py-2'>
                        ...
                        <li>
                          <strong>Span with Category Names:</strong>
                          <ul className='flex flex-col space-y-2 py-2'>
                            <li><span className='bg-slate-950 dark:bg-white py-1 px-2 rounded-md font-semibold text-sm text-white dark:text-slate-950 shadow-md shadow-slate-700 dark:shadow-slate-950'>Category</span>
                            <span> -  Denotes the category of tasks.</span></li>
                          </ul>
                        </li>

                        <li>
                          <strong>Ctrl + F or Cmd + F:</strong>
                          <ul>
                        ...
                        <li>
                          ...
                          <ul>
                            <li><em>__-__-____ Date Format:</em> Displays the task creation date.</li>
                          </ul>
                        </li>
                      </ol>
                    </div>
